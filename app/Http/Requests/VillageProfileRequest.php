...
class VillageProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'org_chart_image' => ['nullable', 'image', 'max:5120'],
            'bpd_chart_image' => ['nullable', 'image', 'max:5120'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'org_chart_image.max' => 'Ukuran bagan organisasi maksimal 5MB.',
            'bpd_chart_image.image' => 'File bagan BPD harus berupa gambar.',
            'bpd_chart_image.max' => 'Ukuran bagan BPD maksimal 5MB.',
        ];
    }
}
