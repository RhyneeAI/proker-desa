...
<section class="bg-[#192E03] pt-[calc(5rem+env(safe-area-inset-top))] sm:pt-[calc(6.5rem+env(safe-area-inset-top))] pb-10 sm:pb-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
        ...
        <div class="min-w-0">
            ...
            @endif
            <h1 class="mt-1.5 text-2xl sm:text-4xl font-extrabold text-white break-words">{{ $title }}</h1>
            @if ($description)
