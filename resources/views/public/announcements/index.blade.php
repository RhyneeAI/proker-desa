            ...
            <div class="space-y-4">
                @foreach ($announcements as $announcement)
                    <a href="{{ route('pengumuman.show', $announcement->slug) }}"
                        class="flex items-start justify-between gap-4 bg-white rounded-xl border border-slate-200 border-l-4 pl-5 pr-5 py-5 transition hover:shadow-lg hover:-translate-y-0.5 hover:border-slate-300 border-l-[#192E03] hover:border-l-[#192E03]">
                        <div class="min-w-0">
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4 flex-shrink-0 text-[#192E03]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
