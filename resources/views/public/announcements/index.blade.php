                    ...
                    <a href="{{ route('pengumuman.show', $announcement->slug) }}"
                        ...
                        <div class="min-w-0">
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4 flex-shrink-0 {{ $announcement->deadline?->isPast() ? 'text-slate-400' : 'text-[#192E03]' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="text-xs text-slate-400 mt-3">{{ $announcement->published_at?->translatedFormat('d F Y') }}</p>
                        </div>
