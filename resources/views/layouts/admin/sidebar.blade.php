            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item" x-data="{ open: {{ $activeGroup === 'konten' ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-cloak class="nav-submenu">
                        ...
                        <a href="{{ route('admin.pengumuman.index') }}" class="d-flex align-items-center gap-2 py-2 ps-3 pe-3 small rounded {{ request()->routeIs('admin.pengumuman.*') ? 'text-white bg-white bg-opacity-10' : 'text-secondary' }}"><i class="ti ti-megaphone" style="width:1.25rem"></i> Pengumuman</a>
                        <a href="{{ route('admin.galeri.index') }}" class="d-flex align-items-center gap-2 py-2 ps-3 pe-3 small rounded {{ request()->routeIs('admin.galeri.*') ? 'text-white bg-white bg-opacity-10' : 'text-secondary' }}"><i class="ti ti-photo" style="width:1.25rem"></i> Galeri</a>
                    </div>
                </li>
                ...
                <li class="nav-item" x-data="{ open: {{ $activeGroup === 'ekonomi' ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-cloak class="nav-submenu">
                        ...
                        <a href="{{ route('admin.wisata.index') }}" class="d-flex align-items-center gap-2 py-2 ps-3 pe-3 small rounded {{ request()->routeIs('admin.wisata.*') ? 'text-white bg-white bg-opacity-10' : 'text-secondary' }}"><i class="ti ti-map-pin-cog" style="width:1.25rem"></i> Wisata</a>
                        <a href="{{ route('admin.potensi.index') }}" class="d-flex align-items-center gap-2 py-2 ps-3 pe-3 small rounded {{ request()->routeIs('admin.potensi.*') ? 'text-white bg-white bg-opacity-10' : 'text-secondary' }}"><i class="ti ti-tools-kitchen-2" style="width:1.25rem"></i> Potensi & Produk</a>
                    </div>
                </li>
                ...
                <li class="nav-item" x-data="{ open: {{ $activeGroup === 'wilayah' ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-cloak class="nav-submenu">
                        ...
                        <a href="{{ route('admin.titik-air.index') }}" class="d-flex align-items-center gap-2 py-2 ps-3 pe-3 small rounded {{ request()->routeIs('admin.titik-air.*') ? 'text-white bg-white bg-opacity-10' : 'text-secondary' }}"><i class="ti ti-droplet" style="width:1.25rem"></i> Titik Air</a>
                        <a href="{{ route('admin.potensi-desa.index') }}" class="d-flex align-items-center gap-2 py-2 ps-3 pe-3 small rounded {{ request()->routeIs('admin.potensi-desa.*') ? 'text-white bg-white bg-opacity-10' : 'text-secondary' }}"><i class="ti ti-mountain" style="width:1.25rem"></i> Potensi Desa</a>
                    </div>
                </li>
                ...
                <li class="nav-item" x-data="{ open: {{ $activeGroup === 'pengaturan' ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-cloak class="nav-submenu">
                        ...
                        <a href="{{ route('admin.kontak.edit') }}" class="d-flex align-items-center gap-2 py-2 ps-3 pe-3 small rounded {{ request()->routeIs('admin.kontak.*') ? 'text-white bg-white bg-opacity-10' : 'text-secondary' }}"><i class="ti ti-phone" style="width:1.25rem"></i> Kontak</a>
                        <a href="{{ route('admin.pengguna.index') }}" class="d-flex align-items-center gap-2 py-2 ps-3 pe-3 small rounded {{ request()->routeIs('admin.pengguna.*') ? 'text-white bg-white bg-opacity-10' : 'text-secondary' }}"><i class="ti ti-users" style="width:1.25rem"></i> Pengguna</a>
                    </div>
                </li>
            </ul>
        </div>
